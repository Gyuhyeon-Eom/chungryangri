...
# 시장별 스토리 — 분석 결과를 사용자 언어로 옮긴 것.
# story: 카드 한 줄 / shelf: 대표 상품 선반 헤드라인 / humanKind: 군집명을 자연어로
MARKET_STORY = {
    "서울약령시장": {
        "humanKind": "한약재 전문 도매",
        "story": "전국 한약재 유통의 중심. 한약재·인삼은 여기서 사는 게 정석입니다.",
        "shelf": "한약재는 서울약령시장 — 전국 유통의 중심, 평일 낮에 가장 활발합니다",
        "flagship": ["한약재", "인삼·홍삼", "건약초"],
    },
    "경동시장": {
        "humanKind": "종합 식자재",
        "story": "청과·건어물·정육까지 한 번에. 점포 수 기준 청량리 최대 종합시장.",
        "shelf": "장보기는 경동시장 — 청과부터 건어물까지 한 번에 담기 좋습니다",
        "flagship": ["청과", "건어물", "정육"],
    },
    "청량리종합시장": {
        "humanKind": "견과·기름 전문",
        "story": "밤·견과류와 방앗간 참기름으로 유명. 명절 선물세트 단골 시장.",
        "shelf": "견과·참기름은 청량리종합시장 — 방앗간 직접 짠 기름이 강점입니다",
        "flagship": ["밤·견과류", "곡류·참기름", "선물세트"],
    },
    "청량리수산시장": {
        "humanKind": "수산 전문",
        "story": "최근 5년 매출이 3배 뛴 수산 전문 시장. 아침 위판 직후가 가장 신선합니다.",
        "shelf": "수산물은 청량리수산시장 — 오전에 들어온 물건이 가장 싱싱합니다",
        "flagship": ["활어", "선어", "패류"],
    },
    "청량리전통시장": {
        "humanKind": "먹거리 골목",
        "story": "통닭골목으로 유명한 먹거리 시장. 저녁 시간대 매출이 가장 큰 곳.",
        "shelf": "저녁 먹거리는 통닭골목 — 옛날 통닭·족발이 저녁에 제일 잘 나갑니다",
        "flagship": ["통닭", "족발", "회"],
    },
    "청량리청과물시장": {
        "humanKind": "과일 전문",
        "story": "강북 최대 과일 시장. 제철 과일은 물량이 많아 가격이 좋습니다.",
        "shelf": "과일은 청량리청과물시장 — 강북 최대 물량, 제철 과일이 쌉니다",
        "flagship": ["제철 과일", "청과 도매"],
    },
    "청량리농수산물시장": {
        "humanKind": "농수산 종합",
        "story": "농산물과 수산물을 함께. 오전 장보기 손님이 많은 동네 시장.",
        "shelf": "기본 찬거리는 농수산물시장 — 오전에 가장 활기찹니다",
        "flagship": ["농산물", "수산물"],
    },
    "동서시장": {
        "humanKind": "청과 골목",
        "story": "청과물시장 옆 골목형 시장. 채소·과일 소량 구매에 편합니다.",
        "shelf": "채소 소량 구매는 동서시장 — 골목형이라 낱개 구매가 편합니다",
        "flagship": ["청과", "채소"],
    },
    "경동광성상가": {
        "humanKind": "한방·건강식품",
        "story": "한약재와 건강식품 상가. 도라지청·홍삼 같은 선물용이 많습니다.",
        "shelf": "건강 선물은 경동광성상가 — 한방 원료 기반 건강식품이 모여 있습니다",
        "flagship": ["건강식품", "한약재"],
    },
}
...
def main():
    ...
    for m, r in clus.iterrows():
        ...
        markets.append({
            ...
            **{k: v for k, v in MARKET_STORY.get(m, {}).items()},
